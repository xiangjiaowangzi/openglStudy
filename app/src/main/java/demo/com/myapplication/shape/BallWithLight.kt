 ...
 * Created by LiuBin
 */
class BallWithLight(view: View) : Shape(view) {
    ...
    init {
        ...
        vertexBuffer = Gl2Utils.transFloatBuffer(dataPos)
        vSize = dataPos.size / 3
    }

    fun createBallPos(): FloatArray {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        mProgram = ShaderUtils.createProgram(mView.resources, "vshader/BallWithLight.sh",
                "fshader/BallWithLight.sh")
    }
