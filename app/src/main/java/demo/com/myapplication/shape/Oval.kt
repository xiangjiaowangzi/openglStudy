...
class Oval : Shape {
    ...
    lateinit var vertexbuff: FloatBuffer
    ...
    //设置颜色，依次为红绿蓝和透明通道
    internal var color = floatArrayOf(0.3f, 0.4f, 0.5f, 1.0f)
    var height = 0.0f
...
//        shapePos = createPositions()
    ...
    constructor(view: View, h: Float) : super(view) {
        this.height = h
        shapePos = createPositions()
    }
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        vertexbuff = Gl2Utils.transFloatBuffer(shapePos)
